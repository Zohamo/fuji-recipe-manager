...
/**
 * Fonctions utilitaires sur les tableaaux.
 */
class ArrayUtils
{
    /**
     ...
     * @return string L'index du premier élément du tableau correspondant à la regex.
     */
     ...
     *
     * @param  array[] $array
     * @param  boolean $overwriteKeys Écrase les clés existantes ou renvoie un tableau séquentiel.
     * @return mixed[]|false
     */
     ...
     * @param  string $key   Clé du tableau où rechercher `$value`.
