...
/**
 * Fonctions utilitaires de cryptage et décryptage.
 *
...
class CryptUtils
{
    ...
    public static function encrypt($str)
    {
        ...
        $key = hash(self::$hashAlgo, env('KEY_CRYPT'));
        // La méthode d'encryption AES-256-CBC attend 16 bytes, sinon elle renverra une erreur
        $iv = substr(hash(self::$hashAlgo, env('KEY_IV')), 0, 16);

        return base64_encode(openssl_encrypt($str, self::$cipherAlgo, $key, 0, $iv));
    }
    ...
    public static function decrypt($str)
    {
        ...
        return openssl_decrypt(base64_decode($str), self::$cipherAlgo, $key, 0, $iv);
    }
