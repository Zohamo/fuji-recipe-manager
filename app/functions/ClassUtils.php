...
/**
 * Fonctions utilitaires sur les classes.
 */
class ClassUtils
{
    /**
     ...
     *
     * @example: `getModel('bureau-vote')` renvoie `new \App\Models\BureauVoteModel()`
     *
    ...
    public static function getName($object, $fullPath = true, $case = null)
    {
        ...
        return in_array($case, ['p', 'pascal', null])
            ? $name
            : StringUtils::switchCase(\App\Functions\StringUtils::camelToSpaced($name), $case);
    }
}
