<form class="form-horizontal form-recherche" method="POST" action="<?= url() ?>/recherche" role="form">
    <div class="d-flex align-items-end">
        ...
        <?php endif ?>
        <button type="submit" class="btn btn-primary" style="height: 38px;" title="<?= alias("recherche", "rechercher") ?>" aria-label="Rechercher">
            <i class="fa-solid fa-magnifying-glass me-2" aria-hidden="true"></i> <?= alias("recherche", "rechercher") ?>
        </button>
    </div>
</form>
