...
trait QueryBuilderSqlToolsTrait
{
     ...
     *
     * @param  SqlClause $sqlClause Clause SQL de référence.
     * @param  string|string[] $clause Clause définie dans la requête.
     * @return string
     */
    private function getCommandWithSeparator(SqlClause $sqlClause, $clause)
    {
        if (is_array($clause)) {
    ...
    {
        if (!method_exists($this, "attributes") || !method_exists($this, "hasProperty")) {
            return $data;
        }
